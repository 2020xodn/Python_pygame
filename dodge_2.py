'''
    ...
    최초 작성일 : 2020.06.08
    최초 변경일 : 2020.xx
    목적 : pygame을 이용한 총알 피하기 Dodge 게임
...
total_score = 0
level_control = 10
total_level = 0 + level_control
total_level_list = [10, 30, 50, 70, 90, 100, 120, 150, 180, 200, 250, 300, 350, 400]

game_font = pygame.font.Font(None, 20)

# relpath = os.path.abspath("./back.png")
# path = os.getcwd().replace('\\',"/")
# print(path + "/back.png")
background = pygame.image.load("back.png")
# background = pygame.image.load("D:\\＃대학\\＃전공\\Python\\pygame\\pygame_basic\\back.png")
...
while running:
    ...
    # 적 생성
    if total_score >= total_level_list[total_level - level_control]:
        total_level += 1

    if total_level >= len(enemy_list):
